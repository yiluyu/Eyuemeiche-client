...
- (void)createBottomView {
    //预定
    self.bookOrderBtn = [YLYRootButton createButtonText:@"我要洗车"
    ...
    self.localLabel = [YLYRootLabel createLabelText:@"测试--点击搜索地址"
                                               font:YLY6Font(14)
    ...
    self.searchBtn = [YLYRootButton createButtonText:nil
                                          titleColor:nil
                                           titleFont:nil
                                 backgroundImageName:nil
                                              target:self
    ...
    self.typeLeftBtn = [YLYRootButton createButtonText:@"现在"
    ...
    self.typeRightBtn = [YLYRootButton createButtonText:@"预约"
    ...
    //回到当前定位点
    self.returnMyLocationBtn = [YLYRootButton createButtonText:nil
                                                    titleColor:nil
                                                     titleFont:nil
...
- (void)enterOrder {
    if (self.callBtnBlock) {
        NSString *type = [NSString stringWithFormat:@"%ld", orderType];
        NSDictionary *postDict = @{@"orderType":type};
